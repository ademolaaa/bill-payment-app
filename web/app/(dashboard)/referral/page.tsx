      ...
      <div className="px-5 flex flex-col space-y-4">
        ...
        <div className="bg-white p-4 rounded-3xl shadow-sm border border-gray-100 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="text-[13px] font-medium text-gray-500 mb-0.5">Referral Code</p>
              <h2 className="text-[18px] font-bold text-gray-900">{referralCode}</h2>
            </div>
          </div>
        ...
        <Link href="/referral/successful" className="bg-white p-4 rounded-3xl shadow-sm border border-gray-100 flex items-center space-x-3 hover:bg-gray-50 transition-colors">
          <div className="w-10 h-10 rounded-full bg-green-50 flex items-center justify-center text-green-600">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>
          </div>
          <div>
            <p className="text-[13px] font-medium text-gray-500 mb-0.5">Successful Referrals</p>
            <h2 className="text-[18px] font-bold text-gray-900">0</h2>
          </div>
        </Link>

        {/* Total Earnings Card */}
        <div className="bg-white p-4 rounded-3xl shadow-sm border border-gray-100 flex items-center space-x-3 mb-4">
          <div className="w-10 h-10 rounded-full bg-blue-50 flex items-center justify-center text-blue-600">
          ...
          <div>
            <p className="text-[13px] font-medium text-gray-500 mb-0.5">Total Earnings</p>
            <h2 className="text-[18px] font-bold text-gray-900">0 USDT</h2>
          </div>
        </div>
        ...
        <div className="bg-blue-50/50 p-5 rounded-3xl border border-blue-100">
          <div className="flex items-center space-x-2 mb-4">
            ...
            <h3 className="text-[16px] font-bold text-gray-900">Rules</h3>
          </div>
