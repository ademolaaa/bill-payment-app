...
export default function TermsPage() {
  return (
    <div className="flex flex-col min-h-screen bg-white relative pb-24">
      {/* Header */}
      <header className="p-4 pt-10 flex items-center justify-between border-b border-gray-100 bg-white sticky top-0 z-10">
        ...
        <h1 className="text-lg font-bold text-gray-900 absolute left-1/2 transform -translate-x-1/2">Terms of Use</h1>
        <div className="w-8"></div>
      </header>

      <div className="flex-grow p-6 prose prose-sm text-gray-600 max-w-none">
        <p className="text-xs font-semibold uppercase tracking-wider text-gray-400 mb-6">Last Updated: October 2026</p>
        
        <h2 className="text-[17px] font-bold text-gray-900 mb-2">1. Acceptance of Terms</h2>
        ...
        <h2 className="text-[17px] font-bold text-gray-900 mb-2">2. Eligibility and KYC</h2>
        <p className="mb-6 leading-relaxed">
        ...
        <h2 className="text-[17px] font-bold text-gray-900 mb-2">3. Service Disruptions</h2>
        <p className="mb-6 leading-relaxed">
        ...
        <h2 className="text-[17px] font-bold text-gray-900 mb-2">4. Account Security</h2>
        <p className="mb-6 leading-relaxed">
