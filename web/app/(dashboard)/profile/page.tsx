...
export default function ProfilePage() {
  ...
  return (
    <div className="flex flex-col p-4 pt-10 min-h-screen bg-slate-50 pb-28">
      ...
      <section className="bg-white rounded-3xl p-6 shadow-sm border border-gray-100 flex flex-col mb-5">

        {/* Avatar row */}
        <div className="flex items-center mb-5">
          {/* Avatar with camera edit overlay */}
          <div className="relative mr-4 flex-shrink-0">
            <div className="w-[70px] h-[70px] rounded-full bg-gray-100 border-2 border-gray-200 flex items-center justify-center overflow-hidden">
              {/* User silhouette SVG */}
        ...
        >
          ...
          <span className="text-sm font-semibold text-red-600 bg-white px-3 py-1.5 rounded-full shadow-sm ml-3 whitespace-nowrap flex-shrink-0">
            Verify Now
          </span>
        </Link>
      </section>
      ...
      {/* ── Profile Links ─────────────────────────────────────────────────── */}
      <section className="bg-white rounded-3xl shadow-sm border border-gray-100 mb-6 overflow-hidden">
        {PROFILE_LINKS.map((link, index) => (
          ...
          >
            ...
            <span className="text-[15px] font-medium text-gray-800 flex-grow">{link.label}</span>
      ...
      <button
        ...
        className="w-full bg-white border border-red-100 rounded-2xl p-4 flex items-center justify-center space-x-2 text-red-600 font-bold text-[16px] shadow-sm hover:bg-red-50 active:scale-[0.98] transition-all duration-150"
      >
        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center">
          ...
          <div className="bg-white rounded-t-3xl sm:rounded-3xl p-6 w-full max-w-sm relative z-10">
            <div className="flex flex-col items-center text-center mb-6">
              ...
              <p className="text-sm text-gray-500 mt-1">You will need to sign back in to access your account.</p>
            </div>
            <div className="flex flex-col space-y-3">
              ...
              <button
                ...
                className="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold rounded-2xl py-4 text-[15px] transition-colors"
              >
                Cancel
              </button>
            </div>
