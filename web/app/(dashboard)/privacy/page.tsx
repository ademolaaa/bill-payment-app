  ...
  return (
    <div className="flex flex-col min-h-screen bg-white relative pb-24">
      ...
      <header className="p-4 pt-10 flex items-center justify-between border-b border-gray-100 bg-white sticky top-0 z-10">
        ...
        <h1 className="text-lg font-bold text-gray-900 absolute left-1/2 transform -translate-x-1/2">Privacy Policy</h1>
      ...
      <div className="flex-grow p-6 prose prose-sm text-gray-600 max-w-none">
        ...
        <h2 className="text-[17px] font-bold text-gray-900 mb-2">1. Data Collection</h2>
        ...
        <h2 className="text-[17px] font-bold text-gray-900 mb-2">2. Data Usage</h2>
        <p className="mb-6 leading-relaxed">
        ...
        <h2 className="text-[17px] font-bold text-gray-900 mb-2">3. Data Sharing</h2>
        <p className="mb-6 leading-relaxed">
        ...
        <h2 className="text-[17px] font-bold text-gray-900 mb-2">4. Your Rights</h2>
        <p className="mb-6 leading-relaxed">
