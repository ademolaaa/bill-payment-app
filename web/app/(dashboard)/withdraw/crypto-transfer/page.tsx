  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 pb-24">
      <header className="p-4 pt-10 flex items-center justify-between border-b border-gray-100 bg-white shadow-sm relative z-10">
        ...
        <h1 className="text-[17px] font-bold text-gray-900 absolute left-1/2 transform -translate-x-1/2">USDT (TRC20) Transfer</h1>
      ...
      <div className="px-5 pt-6 flex flex-col space-y-6">
        ...
        <form className="flex flex-col space-y-6">
          <div className="bg-white p-5 rounded-3xl shadow-sm border border-gray-100 flex flex-col space-y-5">
            <div>
              <label htmlFor="wallet-address" className="block text-gray-800 text-[14px] font-medium mb-1.5 ml-1">Wallet Address</label>
              <div className="relative">
                ...
                <input id="wallet-address" type="text" placeholder="Paste wallet address" className="w-full pl-14 pr-4 py-3.5 border border-gray-200 rounded-2xl text-[14px] text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500" />
              </div>
            </div>

            <div>
              <label htmlFor="network" className="block text-gray-800 text-[14px] font-medium mb-1.5 ml-1">Network</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                ...
                <input id="network" type="text" value="TRON (TRC20)" disabled className="w-full pl-14 pr-10 py-3.5 border border-gray-200 bg-gray-50 rounded-2xl text-[14px] text-gray-900 focus:outline-none" />
