      ...
      <div className="px-5 pt-6 flex flex-col space-y-6">
        ...
        <form className="flex flex-col space-y-6">
          <div className="bg-white dark:bg-slate-900 p-5 rounded-3xl shadow-sm border border-gray-100 flex flex-col space-y-5">
            <div>
              <label htmlFor="wallet-address" className="block text-gray-800 dark:text-slate-200 text-[14px] font-medium mb-1.5 ml-1">Wallet Address</label>
            ...
            <div>
              <label htmlFor="network" className="block text-gray-800 dark:text-slate-200 text-[14px] font-medium mb-1.5 ml-1">Network</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
