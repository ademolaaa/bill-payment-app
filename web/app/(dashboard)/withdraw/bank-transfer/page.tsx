          ...
          <div className="bg-white dark:bg-slate-900 p-5 rounded-3xl shadow-sm border border-gray-100 flex flex-col space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input id="bank-name" type="text" placeholder="Enter bank name" className="w-full pl-14 pr-4 py-3.5 border border-gray-200 rounded-2xl text-[14px] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500" />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input id="account-number" type="text" placeholder="Enter account number" className="w-full pl-14 pr-4 py-3.5 border border-gray-200 rounded-2xl text-[14px] text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500" />
              </div>
            </div>
