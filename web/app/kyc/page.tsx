  ...
  return (
    <div className="flex flex-col min-h-screen bg-white pb-10">
      ...
      <header className="px-4 pt-12 pb-4 flex items-center mb-2">
        <button onClick={() => router.back()} className="p-2 -ml-2 rounded-full hover:bg-gray-100 transition-colors mr-1">
          ...
          <div className="flex-grow space-y-6">
            ...
            <div>
              ...
              <div className="relative">
                <select 
                  className="w-full border border-gray-200 rounded-[12px] py-3.5 px-4 text-[#111827] bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 appearance-none font-medium text-[16px] shadow-sm"
                  value={idType}
                ...
                <div className="absolute inset-y-0 right-0 flex items-center px-4 pointer-events-none text-gray-800">
            ...
            <div>
              ...
              <button type="button" className="w-full border border-gray-200 rounded-[12px] py-4 flex items-center justify-center space-x-2 bg-white hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 shadow-sm">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-gray-800 transform -rotate-45" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13" /></svg>
